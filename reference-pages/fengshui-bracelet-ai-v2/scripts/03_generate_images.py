...
def generate_main_images():
    ...
    # 读取prompts
    prompts_file = PROMPTS_DIR / 'main-images-prompts.json'
...
def generate_summary_report(main_success, main_failed, avatar_success, avatar_failed):
    ...
    # 保存报告
    report_file = PROJECT_ROOT / 'GENERATION_REPORT.md'
...
def main():
    print("\n")
    print("=" * 70)
    print("🚀 FengShui Bracelet AI - 图片批量生成")
    print("=" * 70)
    ...
    print(f"📁 输出目录: {IMAGES_DIR}")
    print("=" * 70)
    print("\n💡 下一步: 运行 04_generate_html.py 生成最终网页")
    print()
